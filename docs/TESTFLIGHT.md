...
The [one-finger pan workflow](https://github.com/kpresidente/lp-sketch/actions/runs/35354553061) passed on September 18, 2026, uploading **0.1.0 (20.1)** from `492c7b93c9c18c7fa3ea0fdc7e9233ee16a51423`. Both archives, IPA export, Apple validation, and upload succeeded. Apple processed build resource `6ca769be-adf0-45dc-9fd2-22fa49ea4614` successfully; the previously approved standard-encryption/no-France answers cleared Missing Compliance. The build is assigned to the existing `iPad Development` group, and the App Store Connect API confirms `IN_BETA_TESTING`. All implementation PR checks passed. The PR remains a draft, unmerged into browser production. Update through TestFlight, then enable **Tools → One-finger pan** to test the optional behavior.
