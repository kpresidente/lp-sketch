...
- The native export follow-up shipped as `0.1.0 (9.1)` through [workflow 35285508431](https://github.com/kpresidente/lp-sketch/actions/runs/35285508431). Apple completed processing, and the existing internal group lists the build as **Testing**. Its physical-iPad update/export checks remain pending.
