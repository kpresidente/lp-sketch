...
- The native export follow-up shipped as `0.1.0 (9.1)` through [workflow 35285508431](https://github.com/kpresidente/lp-sketch/actions/runs/35285508431). Apple completed processing, and the existing internal group lists the build as **Testing**. On September 18, following this delivery, the user confirmed PDF export succeeded on the iPad with all drawing elements present. PNG/JPG, project Save/reload, cancellation, and offline export checks remain pending.
