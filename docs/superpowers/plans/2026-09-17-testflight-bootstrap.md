...
- On September 17, 2026, the user confirmed opening the TestFlight build on a physical iPad, importing a PDF, and drawing elements over it. PDF export, offline reopening, project recovery, rotation, and updating to a subsequent build remain unverified.
