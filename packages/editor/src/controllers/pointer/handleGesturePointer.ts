import { clamp, distance } from '@lp-sketch/core/lib/geometry'
import type { SnapPointPreview, TouchGestureState } from '@lp-sketch/core/types/appRuntime'
import type { Point, Selection } from '@lp-sketch/core/types/project'
