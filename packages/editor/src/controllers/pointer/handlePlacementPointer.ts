...
import { isDownleadSymbolType } from '@lp-sketch/core/lib/conductorFootage'
import { DIRECTIONAL_SYMBOLS, classForSymbol, colorForSymbol } from '@lp-sketch/core/model/defaultProject'
import type {
  LpProject,
  Point,
  Selection,
