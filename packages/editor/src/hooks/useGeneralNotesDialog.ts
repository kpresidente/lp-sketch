...
import { normalizeGeneralNoteText, normalizeGeneralNotesList } from '@lp-sketch/core/lib/generalNotes'
import type { GeneralNotesDialogDragState, GeneralNotesEditState } from '@lp-sketch/core/types/appRuntime'
