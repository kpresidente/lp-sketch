...
import { buildLegendDisplayEntries, legendEditorBaseLabel, legendEditorItemName } from '@lp-sketch/core/lib/legendDisplay'
import type { LegendLabelDialogDragState, LegendLabelEditState } from '@lp-sketch/core/types/appRuntime'
import type { LpProject, Point, Selection } from '@lp-sketch/core/types/project'
