...
vi.mock('@lp-sketch/core/model/migration', async () => {
  const actual = await vi.importActual<typeof import('@lp-sketch/core/model/migration')>('@lp-sketch/core/model/migration')
  return {
    ...actual,
...
vi.mock('@lp-sketch/core/model/validation', async () => {
  const actual = await vi.importActual<typeof import('@lp-sketch/core/model/validation')>('@lp-sketch/core/model/validation')
  return {
    ...actual,
