...
} from '@lp-sketch/core/lib/snapping/resolveInputPoint'
import { resolveSnapPoint as resolveSnapPointEngine } from '@lp-sketch/core/lib/snapping/resolveSnapPoint'
import {
...
} from '@lp-sketch/core/lib/selection/selectionHandles'
import { hitTest as hitTestEngine } from './lib/selection/hitTest'
import { moveSelectionsByDelta as moveSelectionsByDeltaEngine } from '@lp-sketch/core/lib/selection/moveSelection'
import {
...
} from '@lp-sketch/core/lib/annotationScale'
import {
  ...
  screenToDoc,
} from '@lp-sketch/core/lib/geometry'
import {
  DEFAULT_AT_LETTER,
...
} from '@lp-sketch/core/lib/legend'
import {
  buildLegendDisplayEntries,
  type LegendDisplayEntry,
} from '@lp-sketch/core/lib/legendDisplay'
import { legendBoxSize, legendLineText } from '@lp-sketch/core/lib/legendUi'
import {
  GENERAL_NOTES_TITLE,
  MAX_GENERAL_NOTES_COUNT,
  resolvedGeneralNotesForPage,
} from '@lp-sketch/core/lib/generalNotes'
import {
  ...
  symbolLayer,
  symbolSublayer,
} from '@lp-sketch/core/lib/layers'
import { filterProjectByViewport, viewportDocRect } from '@lp-sketch/core/lib/viewportCulling'
import {
...
} from '@lp-sketch/core/lib/conductorFootage'
import { buildAutoConnectorSymbolsForAddedConductors } from '@lp-sketch/core/lib/autoConnectors'
import {
  dimensionTextLabel,
...
import {
  ...
  polylineLength,
  type CornerKind,
} from '@lp-sketch/core/lib/spacing'
import {
  hasSelection,
  selectionsKeySet,
} from '@lp-sketch/core/lib/selection'
import { cloneProject } from '@lp-sketch/core/lib/projectState'
import { clampPageNumber, normalizePageCount } from '@lp-sketch/core/lib/pageState'
import { realUnitsPerPointFromCalibrationSpan } from '@lp-sketch/core/lib/scale'
import {
  buildReportPayload,
...
import { applyRedo, applyUndo, pushHistorySnapshot } from '@lp-sketch/core/model/history'
import {
  COLOR_HEX,
  DIRECTIONAL_SYMBOLS,
  SYMBOL_LABELS,
  ...
  createElementId,
} from '@lp-sketch/core/model/defaultProject'
import { syncLegendItems } from '@lp-sketch/core/model/projectSync'
import type {
...
import type {
  ...
  TouchGestureState,
  TouchSpacingPending,
} from '@lp-sketch/core/types/appRuntime'
