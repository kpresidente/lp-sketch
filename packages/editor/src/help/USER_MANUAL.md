...
- **One-finger pan (iPad app)** -- Drag the view with a finger or thumb from any tool. Small movements are ignored, and panning does not change zoom or add an Undo step.

### 12.3. Touch Gestures {#help-canvas-navigation-touch}

In the **iPad app**, use the Pencil to place, select, and edit objects. Fingers operate controls and navigate the canvas: drag with one finger to pan, or use two fingers to pan and zoom. Pencil contact stops touch navigation, and resting hand contacts remain ignored until lifted. Lift your hand before starting a new finger gesture. The two-tap conductor workflow is unchanged, including when you pan between endpoint taps.
