 ...
 * node packages/editor/src/help/build-help.mjs apps/web/public
 * Integrated into consuming applications through the shared Vite plugin.
 */
...
if (!process.argv[2]) {
  throw new Error('Usage: node build-help.mjs <application-public-directory>')
}
