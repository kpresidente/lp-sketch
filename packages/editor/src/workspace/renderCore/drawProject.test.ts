...
import { scaledLegendMetrics, wireStrokeWidthForScale } from '@lp-sketch/core/lib/annotationScale'
import { legendSymbolCenterOffsetY, legendSymbolScale } from '@lp-sketch/core/lib/legendSymbolScale'
