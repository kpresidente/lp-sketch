...
import type { LpProject, SymbolElement } from '@lp-sketch/core/types/project'
import {
...
import { circularArcGeometryFromThreePoints } from '@lp-sketch/core/lib/geometry'
import { GENERAL_NOTES_TITLE, generalNotesBoxSize, generalNotesDisplayLines, scaledGeneralNotesMetrics } from '@lp-sketch/core/lib/generalNotes'
import { buildLegendItemsFromSymbols } from '@lp-sketch/core/lib/legend'
import { buildLegendDisplayEntries, type LegendDisplayEntry } from '@lp-sketch/core/lib/legendDisplay'
import { legendSymbolCenterOffsetY, legendSymbolDirectionDeg, legendSymbolScale } from '@lp-sketch/core/lib/legendSymbolScale'
